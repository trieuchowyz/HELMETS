...
<script>
    $(document).ready(function() {
        ...
        // ĐÃ XÓA ĐOẠN XỬ LÝ .btn-plus VÀ .btn-minus Ở ĐÂY ĐỂ TRÁNH TRÙNG LẶP

        // Xử lý nút Thêm vào giỏ hàng bằng Ajax (giữ nguyên)
        $('.btn-add-detail').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    alert(response.message || "Đã thêm vào giỏ hàng thành công!");
                },
                error: function(xhr) {
                    if (xhr.status === 401) {
