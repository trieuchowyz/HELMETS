...
@section('title', 'Quản lý Mũ/Nón')

@section('content')
<div class="card shadow-sm border-0">
    <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
        <h6 class="mb-0 fw-bold">Danh sách Mũ/Nón</h6>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{ route('admin.products.delete', $item->id) }}" class="btn btn-sm btn-outline-danger" onclick="return confirm('Xóa sản phẩm này?')" title="Xóa"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
